...
function CourtIllustration({ isSelected }) {
  ...
  return (
    <svg viewBox="0 0 200 120" width="100%" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block' }}>
      ...
      <ellipse cx="43" cy="93" rx="5" ry="1.8" fill="rgba(0,0,0,0.22)" />
      {/* Bola */}
      <circle cx="40" cy="86" r="5" fill="#d4e800" />
      {/* Brilho */}
      <circle cx="38" cy="84" r="1.6" fill="rgba(255,255,255,0.50)" />
      {/* Costuras laranja */}
      <path d="M37,82 Q43,86 37,90" stroke="#e85000" strokeWidth="3.0" fill="none" />
                        ...
                        <div className="reservation-actions">
                          ...
                          >
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                              <path d="M410.3 231l11.3-11.3-33.9-33.9-62.1-62.1-33.9-33.9-11.3 11.3-22.6 22.6L58.6 322.9c-10.4 10.4-18 23.3-22.2 37.4L1 480.7c-2.5 8 .5 16.7 7.1 22.7s15.5 8 22.8 4.9l161.7-72.7c13.8-6.2 26.3-15.1 36.1-26.3l119.7-130.2 22.6-22.6 39.6-39.6zM418.4 92.4l25.2 25.2c12.5 12.5 12.5 32.8 0 45.3l-32.8 32.8-70.5-70.5 32.8-32.8c12.5-12.5 32.8-12.5 45.3 0z"/>
                            </svg>
                          </button>
                          <button
