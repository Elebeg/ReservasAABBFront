...
const VetBadge = () => (
  <span style={{ marginLeft: 5, fontSize: '0.62rem', fontWeight: 700, color: '#fff', background: '#0e244a', borderRadius: 3, padding: '1px 5px', verticalAlign: 'middle' }}>VET</span>
);

const SuspBadge = () => (
  <span style={{ marginLeft: 5, fontSize: '0.62rem', fontWeight: 700, color: '#fff', background: '#a73022', borderRadius: 3, padding: '1px 5px', verticalAlign: 'middle' }}>SUSPENSO</span>
);

const PendBadge = () => (
  <span style={{ marginLeft: 5, fontSize: '0.62rem', fontWeight: 700, color: '#0e244a', background: '#c89525', border: '1px solid #a07415', borderRadius: 3, padding: '1px 6px', verticalAlign: 'middle' }}>pendurado</span>
);
